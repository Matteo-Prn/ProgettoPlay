...
/**
 * Controller per la pagina della classifica amministratore.
 */
public class RankAdminController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        sidebarAdminController.selectRankingButton();
        setupTable();
        loadRankings();
